  ...
  return (
    <div className={styles.inputs}>
      ...
      {data.option !== 'pet' && (
        <label
          ...
          className={clsx(styles.label, {
            [styles.invalid]: invalids.includes('addTitle'),
          })}
        >
          Title of add
          <input
      ...
      <label
        id="name"
        className={clsx(styles.label, {
          [styles.invalid]: invalids.includes('name'),
        })}
      >
        Pet's name
        <input
      ...
      <label
        id="birth"
        className={clsx(styles.label, {
          [styles.invalid]: invalids.includes('birth'),
        })}
      >
        Date of birth
        <input
      ...
      <label
        id="type"
        className={clsx(styles.label, {
          [styles.invalid]: invalids.includes('type'),
        })}
      >
        Breed
        <input
